...
export default function AdminUpdatesFirebasePage() {
    ...
    return (
      <div className="container py-24 flex justify-center items-center">
        <Card className="w-full max-w-sm">
          <CardHeader>
            <CardTitle className="text-center">Admin Access (Firebase)</CardTitle>
          </CardHeader>
          <CardContent>
  ...
  return (
    <div className="container py-12">
      <h1 className="text-3xl font-bold mb-8">Admin - Manage Updates (Firebase)</h1>
